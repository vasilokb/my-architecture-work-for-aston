...
| [career-aggregator/](career-aggregator/) | Карьерный агрегатор / Career Planner | 03–09.2026 | Три итерации: код (hexagonal, pgvector-прототип), ТЗ, 5 версий диаграмм, архитектура v1.2 + консультации C8–C10 |
